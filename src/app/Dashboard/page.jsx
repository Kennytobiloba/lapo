...
import { FaAngleRight, FaCreditCard, FaRegHourglass } from "react-icons/fa";
import {
  MdArrowOutward,
  MdCreditCard,
...
const page = () => {
  return (
    <>
      ...
      >
        <div className="flex flex-col gap-4 space-y-2 lg:space-y-0 
        md:flex-row md:justify-between lg:items-center px-2">
        <div>
        <p className="lg:text-[18px] text-[16px] font-bold 
        text-[#121212] font-sans leading-[24px]">
          Hi Nazeer, what would you like to do today?
        </p>
        <p className="text-[12px] font-normal text-[#121212] font-sans mt-2">
          Last login: 26/11/2024 14:39:58
        </p>
        </div>

          {/* Calendar Section */}
        <div className="flex  md:items-center gap-2  w-[60%] md:w-auto
         border-[#D0D5DD] border text-[13px] px-3 py-2 rounded-md">
          <span className=" text-[#121212] text-lg text-[8px]">
           <FaRegCalendarAlt />
          </span>
          <span>Today</span>
        ...
        <div className="bg-white rounded-[10px] border-[1px] py-4 px-2 mt-4">
          ...
          <h4 className="text-[14px] font-[500px] text-[#121212] font-sans ">
            Manage a Card
          </h4>
          ...
          <div className="bg-[#F1F7FF] rounded-[4px] flex gap-4 px-2 py-2 items-center">
          <span className="h-[28px] w-[28px] rounded-full bg-[#014DAF] text-[14px] text-white
          ...
          <div className="bg-[#F1F7FF] rounded-[4px] flex gap-4 px-2 py-2 
          items-center border border-[#E2E2E2]">
          <span className="h-[28px] w-[28px] rounded-full bg-[#014DAF] 
          text-[14px] text-white flex justify-center items-center ">
            <MdOutlineCreditScore />
          </span>
          <div className="flex gap-2 items-center ">
          <h4 className="text-[14px] font-[500px] text-[#121212] font-sans">
        ...
        <div className="bg-white rounded-[10px] border border-[#E2E2E2] py-2 px-2">
          ...
          <h3 className="text-[14px] font-[500px]  text-[#121212] font-sans">
          Total Active Cards
          </h3>
          </div>
          <div className="mt-2 flex justify-between  items-center px-1">
          <h2 className="text-[24px] font-[700px]  text-[#121212] font-sans">
            26,478
          </h2>
           <div className="flex gap-1 items-center">
            <div className="w-[56px] h-[20px] bg-[#EFFAFC] flex items-center gap-2 px-1">
            <span className="text-[12px] text-[#29A174]">
              {" "}
            <MdArrowOutward />{" "}
            </span>
          ...
          <div className="flex flex-col gap-1 text-[#E78020]">
            ...
            <div className="mt-2 flex justify-between  items-center px-1">
              ...
              <span className="text-[12px] text-[#E78020]">
                <CiCircleCheck />
              </span>
                <span className="text-[12px] text-[#E78020]">
                  Requires attention
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 w-full h-full mt-8 gap-4 space-y-4">
          <div className="h-[318px] bg-white border border-[#E2E2E2] px-2 py-2 ">
            <h3 className="text-[18px] font-[500px] ml-4 mt-2  text-[#121212] font-sans">
              Monthly Issuance
            </h3>
            <Barchart />
          </div>
          <div className="h-[318px] bg-white border border-[#E2E2E2] px-2 py-2 ">
            <div className="flex justify-between">
              ...
              <span className="text-[#D0D5DD] text-[16px] font-bold mr-2 items-center">
                <FiMaximize2 />
              </span>
            </div>
            <Table />
